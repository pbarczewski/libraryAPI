...
public class ISBNRestExceptionHandler {
	...
	public ResponseEntity<ISBNErrorResponse> handleException(CustomizeException e) {
		ISBNErrorResponse error = new ISBNErrorResponse(HttpStatus.NOT_FOUND.value(), e.getMessage(), System.currentTimeMillis());
		return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
	}
	
	@ExceptionHandler
	public ResponseEntity<ISBNErrorResponse> handleException(Exception e) {
		ISBNErrorResponse error = new ISBNErrorResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage(), System.currentTimeMillis());
